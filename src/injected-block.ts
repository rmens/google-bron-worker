...
.google-aanjager-cta--dark{background:#1a1a1a !important;border-color:rgba(255,255,255,.12) !important;color:#ececec}
.google-aanjager-cta--dark .google-aanjager-copy b{color:#fff}
.google-aanjager-cta--dark .google-aanjager-copy span{color:#a7a7a7}
</style>`;
...
export function buildInjectedHtml(site: SiteConfig): string {
  const cls = site.theme === "dark"
    ? "google-aanjager-cta google-aanjager-cta--dark"
    : "google-aanjager-cta";
  return `${STYLE}
<div class="${cls}" role="complementary" aria-label="Maak ${esc(site.name)} een voorkeursbron in Google">
